...
from jifimogs.tools.fitutil import  sepHash, channelMins
...
def timeline_v2(bfn, datfn, itvfn, outfn="timeline", ch1=0, ch2=1, xL=0, xH=3, yticks=[0, 1, 2, 3], thin=1, allFR=None, tcksz=19, lblsz=21, t0=None, t1=None, figw=10, figh=10, ytpos="left"):   #  25Hz
    ...
    if ytpos == "left":
        mF.arbitraryAxes(ax, axesVis=[True, True, False, False], xtpos="bottom", ytpos="left")
        mF.setTicksAndLims(xlabel=None, ylabel="channel 1\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[0], wvfmMax[0]], tickFS=tcksz, labelFS=lblsz)
    else:
        mF.arbitraryAxes(ax, axesVis=[False, True, True, False], xtpos="bottom", ytpos="right")
        mF.setTicksAndLims(xlabel=None, ylabel="channel 1\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[0], wvfmMax[0]], tickFS=tcksz, labelFS=lblsz)
    ...
    if ytpos == "left":
        mF.arbitraryAxes(ax, axesVis=[True, True, False, False], xtpos="bottom", ytpos="left")
        mF.setTicksAndLims(xlabel=None, ylabel="channel 2\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[1], wvfmMax[1]], tickFS=tcksz, labelFS=lblsz)
    else:
        mF.arbitraryAxes(ax, axesVis=[False, True, True, False], xtpos="bottom", ytpos="right")
        mF.setTicksAndLims(xlabel=None, ylabel="channel 2\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[1], wvfmMax[1]], tickFS=tcksz, labelFS=lblsz)
    for ep in range(epochs):
    ...
    if ytpos == "left":
        mF.arbitraryAxes(ax, axesVis=[True, True, False, False], xtpos="bottom", ytpos="left")
        mF.setTicksAndLims(xlabel=None, ylabel="channel 3\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[2], wvfmMax[2]], tickFS=tcksz, labelFS=lblsz)
    else:
        mF.arbitraryAxes(ax, axesVis=[False, True, True, False], xtpos="bottom", ytpos="right")
        mF.setTicksAndLims(xlabel=None, ylabel="channel 3\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[2], wvfmMax[2]], tickFS=tcksz, labelFS=lblsz)
    for ep in range(epochs):
    ...
    if ytpos == "left":
        mF.arbitraryAxes(ax, axesVis=[True, True, False, False], xtpos="bottom", ytpos="left")
        mF.setTicksAndLims(xlabel="time (s)", ylabel="channel 4\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[3], wvfmMax[3]], tickFS=tcksz, labelFS=lblsz)
    else:
        mF.arbitraryAxes(ax, axesVis=[False, True, True, False], xtpos="bottom", ytpos="right")
        mF.setTicksAndLims(xlabel="time (s)", ylabel="channel 4\nmark (mV)", xticks=None, yticks=[], xticksD=None, yticksD=None, xlim=[0, N/1000.], ylim=[wvfmMin[3], wvfmMax[3]], tickFS=tcksz, labelFS=lblsz)
    for ep in range(epochs):
